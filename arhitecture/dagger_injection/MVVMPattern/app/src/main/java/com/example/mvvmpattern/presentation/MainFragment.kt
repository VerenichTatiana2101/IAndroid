...
import com.example.mvvmpattern.di.DaggerAppComponent
...
class MainFragment : Fragment() {
    ...
    private val viewModel: MainViewModel by viewModels {
        // добавляется префикс Dager независимо от названия app компонента
        // сначала запустим сборку, потом подтягиваем DaggerAppComponent
